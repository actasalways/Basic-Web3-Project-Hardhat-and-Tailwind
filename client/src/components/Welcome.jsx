      ...
      <div className="flex mf:flex-row flex-col items-start justify-between md:p-20 py-20 px-4">
        <div className="flex flex-1 justify-start flex-col mf:mr-10 ">
          ...
          <button
            ...
            className="flex flex-row justify-center items-centermy-5 bg-[#2952e3] p-3 rounded-full cursor-pointer hover:bg-[#2546bd]"
          >
        ...
        <div className="flex flex-col flex-1 items-center justify-start s-full mf:mt-0 mt-10">
